"""
Legacy build script for creating a standalone X4 Ship Parse executable.
...
'''
    ...
    with open("install.bat", "w", encoding="utf-8") as installer_file:
        installer_file.write(installer_content)
